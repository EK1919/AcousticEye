...
import Flow_process.sentinel_client_elta as sce
from .conf import Configuration
from .receiver import HypermicPCMReceiver
from .streamer import AudioStream

from Flow_process.sentinel_client_elta.mic_api_base import MicApiBase, ExtendedAcousticData

from Flow_process.sentinel_client_elta.log_print import bcolors
from Flow_process.sentinel_client_elta.log_print import E_LogPrint
import Flow_process.sentinel_client_elta.log_print as lp
...
class AAMic(MicApiBase):
    ...
    def __init__(self, system_name='korner',device_id=1,sample_rate = 48000,sample_time_in_sec = 1):

        MicApiBase.__init__(self,system_name,device_id,sample_rate,sample_time_in_sec)
        lp.logPrint("INFO", E_LogPrint.BOTH, f"start AA mic", bcolors.FAIL) 
        # start the AA
        self.config = Configuration()
        print(self.config.phi)
